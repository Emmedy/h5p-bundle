...
use Emmedy\H5PBundle\Entity\ContentRepository;
...
use Emmedy\H5PBundle\Entity\LibraryLibrariesRepository;
...
class H5PSymfony implements \H5PFrameworkInterface
{
    ...
    public function isPatchedLibrary($library)
    {
        ...
        $repo = $this->manager->getRepository('Emmedy\H5PBundle\Entity\Library');
    ...
    public function getLibraryUsage($libraryId, $skipContent = FALSE)
    {
        ...
        if ($skipContent) {
            ...
            $libraryRepository = $this->manager->getRepository('Emmedy\H5PBundle\Entity\Library');
            $usage['content'] = $libraryRepository->countContentLibrary($libraryId);
        }
        /** @var LibraryLibrariesRepository $libraryLibrariesRepository */
        $libraryLibrariesRepository = $this->manager->getRepository('Emmedy\H5PBundle\Entity\LibraryLibraries');
    ...
    public function loadLibrary($machineName, $majorVersion, $minorVersion)
    {
        ...
        $libraryRepo = $this->manager->getRepository('Emmedy\H5PBundle\Entity\Library');
        $library = $libraryRepo->findOneArrayBy(['machineName' => $machineName, 'majorVersion' => $majorVersion, 'minorVersion' => $minorVersion]);
        if (!$library) {
            return false;
        }
    ...
    public function getNumNotFiltered()
    {
        ...
        $contentRepo = $this->manager->getRepository('Emmedy\H5PBundle\Entity\Content');
